...
# of the online readiness assessment application for OSP. Your OSP
...
then
    ...
    # Open osp settings file and verify onlinereadiness settings are enabled.
    echo ""
    ...
    # Create or update database table(s) for online readiness app in OSP database.
    echo ""
